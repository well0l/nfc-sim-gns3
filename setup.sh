...
if ! command -v mkcert &>/dev/null; then
    ...
    if [[ "$OSTYPE" == "linux-gnu"* ]]; then
        # Scarica il binario direttamente da GitHub releases
        ...
        # libnss3-tools serve a mkcert per aggiornare Firefox
...
# mkcert genera file con nome dinamico, li rinomino in modo standard
